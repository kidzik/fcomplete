...
Compared to the null model all three methods reduce the \verb|MSE| by $\sim 30\%$. We present detailed results in Table \ref{tbl:data-res} and in Figure \ref{fig:Boxplots}. %\tr{[TODO: UPDATE WITH BETTER RESULTS]}
