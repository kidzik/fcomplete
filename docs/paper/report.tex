...
\begin{figure}[h]
  ...
  \caption{We observe GDI of patients at every visit (left plot), and we can easily derive the population progression (the thick solid curve). The analysis of individual patients (connected dots in the right plot, also differing by color) can reveal patterns in individual trends.}
